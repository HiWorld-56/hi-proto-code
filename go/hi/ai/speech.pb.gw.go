...
func RegisterSpeechHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SpeechServer) error {
	mux.Handle(http.MethodPost, pattern_Speech_Transcribe_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/hi.ai.Speech/Transcribe", runtime.WithHTTPPathPattern("/api/v1/speech/transcribe"))
		if err != nil {
	...
	mux.Handle(http.MethodPost, pattern_Speech_Synthesize_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/hi.ai.Speech/Synthesize", runtime.WithHTTPPathPattern("/api/v1/speech/synthesize"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterSpeechHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SpeechClient) error {
	mux.Handle(http.MethodPost, pattern_Speech_Transcribe_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/hi.ai.Speech/Transcribe", runtime.WithHTTPPathPattern("/api/v1/speech/transcribe"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle(http.MethodPost, pattern_Speech_Synthesize_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/hi.ai.Speech/Synthesize", runtime.WithHTTPPathPattern("/api/v1/speech/synthesize"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
