...
const file_hi_ai_auth_proto_rawDesc = "" +
	"\n" +
	"\x10hi/ai/auth.proto\x12\x05hi.ai\x1a\x0fhi/common.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x11hi/did/auth.proto\x1a\x10hi/options.proto2\x87\x02\n" +
	"\x04Auth\x12=\n" +
	"\fRefreshToken\x12\x17.hi.did.RefreshTokenReq\x1a\r.hi.AuthToken\"\x05\x8a\xb5\x18\x01\x01\x12A\n" +
...
var file_hi_ai_auth_proto_goTypes = []any{
	...
	(*did.LoginQr)(nil),          // 4: hi.did.LoginQr
	(*did.ReqStatusResp)(nil),    // 5: hi.did.ReqStatusResp
...
var file_hi_ai_auth_proto_depIdxs = []int32{
	...
	4, // 5: hi.ai.Auth.GenerateReqId:output_type -> hi.did.LoginQr
	5, // 6: hi.ai.Auth.GetReqStatus:output_type -> hi.did.ReqStatusResp
	6, // 7: hi.ai.Auth.Logout:output_type -> google.protobuf.Empty
