...
func (c *merchantClient) ListGreeters(ctx context.Context, in *ListGreetersReq, opts ...grpc.CallOption) (*ListUsersResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListUsersResp)
...
func (c *merchantClient) List(ctx context.Context, in *ListMerchantsReq, opts ...grpc.CallOption) (*MerchantListResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedMerchantServer) ListGreeters(context.Context, *ListGreetersReq) (*ListUsersResp, error) {
...
func _Merchant_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MerchantServer).List(ctx, req.(*ListMerchantsReq))
	}
	return interceptor(ctx, in, info, handler)
}
