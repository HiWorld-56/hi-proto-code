...
const file_hi_did_merchant_proto_rawDesc = "" +
	...
	"\x04info\x18\x02 \x01(\v2\x19.hi.did.UserExtensionInfoR\x04info\"F\n" +
	"\bGrantReq\x12&\n" +
	...
	"\x04user\x18\x01 \x01(\tR\x04user\"I\n" +
	"\x0fGetUserMqttResp\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\"/\n" +
	"\x15MerchantPubSchemeResp\x12\x16\n" +
	"\x06scheme\x18\x01 \x01(\tR\x06scheme\";\n" +
	"\x15MerchantPubServerResp\x12\"\n" +
	"\x06server\x18\x01 \x01(\v2\n" +
	".hi.EntityR\x06server\">\n" +
	"\x10MerchantExDBResp\x12\x14\n" +
