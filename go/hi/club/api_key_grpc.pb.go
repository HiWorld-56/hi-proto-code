...
const (
	...
	ApiKey_ListApiKeys_FullMethodName = "/hi.club.ApiKey/ListApiKeys"
...
type ApiKeyClient interface {
	...
	ListApiKeys(ctx context.Context, in *did.ListApiKeyReq, opts ...grpc.CallOption) (*did.ListApiKeyResp, error)
...
func (c *apiKeyClient) ListApiKeys(ctx context.Context, in *did.ListApiKeyReq, opts ...grpc.CallOption) (*did.ListApiKeyResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ApiKeyServer interface {
	...
	ListApiKeys(context.Context, *did.ListApiKeyReq) (*did.ListApiKeyResp, error)
	// Deprecated: Do not use.
...
func (UnimplementedApiKeyServer) ListApiKeys(context.Context, *did.ListApiKeyReq) (*did.ListApiKeyResp, error) {
...
func _ApiKey_ListApiKeys_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiKeyServer).ListApiKeys(ctx, req.(*did.ListApiKeyReq))
	}
	return interceptor(ctx, in, info, handler)
}
