...
var filter_File_GetUploadResult_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}

func request_File_GetUploadResult_0(ctx context.Context, marshaler runtime.Marshaler, client FileClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq GetUploadResultReq
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_File_GetUploadResult_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	msg, err := client.GetUploadResult(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
}

func local_request_File_GetUploadResult_0(ctx context.Context, marshaler runtime.Marshaler, server FileServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq GetUploadResultReq
		metadata runtime.ServerMetadata
	)
	...
	msg, err := server.GetUploadResult(ctx, &protoReq)
	return msg, metadata, err
}
...
func RegisterFileHandlerServer(ctx context.Context, mux *runtime.ServeMux, server FileServer) error {
	mux.Handle(http.MethodGet, pattern_File_GetUploadResult_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/hi.media.File/GetUploadResult", runtime.WithHTTPPathPattern("/api/v1/file/get_upload_result"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_File_GetUploadResult_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_File_GetUploadResult_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
...
func RegisterFileHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FileClient) error {
	mux.Handle(http.MethodGet, pattern_File_GetUploadResult_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/hi.media.File/GetUploadResult", runtime.WithHTTPPathPattern("/api/v1/file/get_upload_result"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_File_GetUploadResult_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_File_GetUploadResult_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v1", "file", "get_upload_result"}, ""))
...
var (
	forward_File_GetUploadResult_0 = runtime.ForwardResponseMessage
