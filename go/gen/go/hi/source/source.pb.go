...
const file_hi_source_source_proto_rawDesc = "" +
	...
	"\acontent\x18\x03 \x01(\fB\a\xbaH\x04z\x02\x10\x01R\acontent\"N\n" +
	"\n" +
	"UploadResp\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url\x12 \n" +
	"\tthumb_url\x18\x02 \x01(\tH\x00R\bthumbUrl\x88\x01\x01B\f\n" +
	"\n" +
	"_thumb_url\"-\n" +
	...
	"\x05limit\x18\x03 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x05limit2\x90\x02\n" +
	"\x04File\x125\n" +
	...
	"\x0eDownloadStream\x12\x1c.hi.source.DownloadStreamReq\x1a\x1d.hi.source.DownloadStreamResp0\x01B\x9a\x01\n" +
	"\rcom.hi.sourceB\vSourceProtoP\x01Z7git.hi.lan/HiWorld-56/hi-proto-code/go/gen/go/hi/source\xa2\x02\x03HSX\xaa\x02\tHi.Source\xca\x02\tHi\\Source\xe2\x02\x15Hi\\Source\\GPBMetadata\xea\x02\n" +
