...
const (
	Auth_RefreshToken_FullMethodName  = "/hi.media.Auth/RefreshToken"
	Auth_GenerateReqId_FullMethodName = "/hi.media.Auth/GenerateReqId"
	Auth_GetReqStatus_FullMethodName  = "/hi.media.Auth/GetReqStatus"
)
