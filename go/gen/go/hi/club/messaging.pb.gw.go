...
func RegisterPublisherHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PublisherServer) error {
	mux.Handle(http.MethodPost, pattern_Publisher_Publish_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/hi.club.Publisher/Publish", runtime.WithHTTPPathPattern("/hi.club.Publisher/Publish"))
		if err != nil {
...
func RegisterPublisherHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PublisherClient) error {
	mux.Handle(http.MethodPost, pattern_Publisher_Publish_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/hi.club.Publisher/Publish", runtime.WithHTTPPathPattern("/hi.club.Publisher/Publish"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Publisher_Publish_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"hi.club.Publisher", "Publish"}, ""))
)
