...
impl serde::Serialize for AgentDelayUnit {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.llm.as_ref() {
            struct_ser.serialize_field("llm", v)?;
        }
        if let Some(v) = self.llm2.as_ref() {
            struct_ser.serialize_field("llm2", v)?;
        }
        if let Some(v) = self.stt.as_ref() {
            struct_ser.serialize_field("stt", v)?;
        }
        if let Some(v) = self.tts.as_ref() {
            struct_ser.serialize_field("tts", v)?;
        }
        if let Some(v) = self.function_call.as_ref() {
            struct_ser.serialize_field("functionCall", v)?;
        }
        if let Some(v) = self.test_time.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("testTime", ToString::to_string(&v).as_str())?;
        }
        struct_ser.end()
    }
}
...
impl serde::Serialize for AgentUsageResp {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.message_count.as_ref() {
            struct_ser.serialize_field("messageCount", v)?;
        }
        if let Some(v) = self.token.as_ref() {
            struct_ser.serialize_field("token", v)?;
        }
...
impl serde::Serialize for ChatReq {
        ...
        S: serde::Serializer,
    {
        ...
        if self.echo_tool_calls.is_some() {
            len += 1;
        }
        if self.echo_memory.is_some() {
            len += 1;
        }
        if self.echo_context.is_some() {
            len += 1;
        }
        ...
        if let Some(v) = self.echo_tool_calls.as_ref() {
            struct_ser.serialize_field("echoToolCalls", v)?;
        }
        if let Some(v) = self.echo_memory.as_ref() {
            struct_ser.serialize_field("echoMemory", v)?;
        }
        if let Some(v) = self.echo_context.as_ref() {
            struct_ser.serialize_field("echoContext", v)?;
        }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(ChatReq {
                    ...
                    state: state__,
                    style: style__,
                    echo_tool_calls: echo_tool_calls__,
                    echo_memory: echo_memory__,
...
impl serde::Serialize for CreateAssistantReq {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.CreateAssistantReq", len)?;
...
impl<'de> serde::Deserialize<'de> for CreateAssistantReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = CreateAssistantReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.CreateAssistantReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<CreateAssistantReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut name__ = None;
                ...
                Ok(CreateAssistantReq {
                    name: name__,
                    avatar: avatar__,
                })
            }
        }
        deserializer.deserialize_struct("hi.ai.CreateAssistantReq", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for CreateReferenceReq {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
...
impl<'de> serde::Deserialize<'de> for CreateReferenceReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = CreateReferenceReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.CreateReferenceReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<CreateReferenceReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut agent__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::VersionData => {
                            if version_data__.is_some() {
                                return Err(serde::de::Error::duplicate_field("versionData"));
                            }
        ...
        deserializer.deserialize_struct("hi.ai.CreateReferenceReq", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CreateShellReq {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
...
impl<'de> serde::Deserialize<'de> for CreateShellReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = CreateShellReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.CreateShellReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<CreateShellReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut agent__ = None;
        ...
        deserializer.deserialize_struct("hi.ai.CreateShellReq", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CreateShellResp {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.CreateShellResp", len)?;
        if let Some(v) = self.uuid.as_ref() {
            struct_ser.serialize_field("uuid", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for CreateShellResp {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = CreateShellResp;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.CreateShellResp")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<CreateShellResp, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut uuid__ = None;
        ...
        deserializer.deserialize_struct("hi.ai.CreateShellResp", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for DeleteShellReq {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.DeleteShellReq", len)?;
        if let Some(v) = self.agent.as_ref() {
            struct_ser.serialize_field("agent", v)?;
        }
        if let Some(v) = self.uuid.as_ref() {
...
impl<'de> serde::Deserialize<'de> for DeleteShellReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = DeleteShellReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.DeleteShellReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<DeleteShellReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut agent__ = None;
        ...
        deserializer.deserialize_struct("hi.ai.DeleteShellReq", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DeleteShellsReq {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.DeleteShellsReq", len)?;
        if let Some(v) = self.agent.as_ref() {
            struct_ser.serialize_field("agent", v)?;
        }
        if !self.uuids.is_empty() {
...
impl<'de> serde::Deserialize<'de> for DeleteShellsReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = DeleteShellsReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.DeleteShellsReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<DeleteShellsReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut agent__ = None;
        ...
        deserializer.deserialize_struct("hi.ai.DeleteShellsReq", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DeleteVersionListReq {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.DeleteVersionListReq", len)?;
        if let Some(v) = self.agent.as_ref() {
            struct_ser.serialize_field("agent", v)?;
        }
        if let Some(v) = self.uuid.as_ref() {
...
impl<'de> serde::Deserialize<'de> for DeleteVersionListReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = DeleteVersionListReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.DeleteVersionListReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<DeleteVersionListReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut agent__ = None;
        ...
        deserializer.deserialize_struct("hi.ai.DeleteVersionListReq", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DeleteVersionReq {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.DeleteVersionReq", len)?;
        if let Some(v) = self.agent.as_ref() {
            struct_ser.serialize_field("agent", v)?;
        }
        if let Some(v) = self.uuid.as_ref() {
...
impl<'de> serde::Deserialize<'de> for DeleteVersionReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = DeleteVersionReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.DeleteVersionReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<DeleteVersionReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut agent__ = None;
        ...
        deserializer.deserialize_struct("hi.ai.DeleteVersionReq", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DeleteVersionsReq {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.DeleteVersionsReq", len)?;
        if let Some(v) = self.agent.as_ref() {
            struct_ser.serialize_field("agent", v)?;
        }
        if let Some(v) = self.uuid.as_ref() {
        ...
        if let Some(v) = self.min_version.as_ref() {
            struct_ser.serialize_field("minVersion", v)?;
        }
        if let Some(v) = self.max_version.as_ref() {
            struct_ser.serialize_field("maxVersion", v)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for DeleteVersionsReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                impl serde::de::Visitor<'_> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            "agent" => Ok(GeneratedField::Agent),
                            "uuid" => Ok(GeneratedField::Uuid),
                            "minVersion" | "min_version" => Ok(GeneratedField::MinVersion),
                            "maxVersion" | "max_version" => Ok(GeneratedField::MaxVersion),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = DeleteVersionsReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.DeleteVersionsReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<DeleteVersionsReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut agent__ = None;
                let mut uuid__ = None;
                let mut min_version__ = None;
                let mut max_version__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Agent => {
                            if agent__.is_some() {
                        ...
                        GeneratedField::MinVersion => {
                            if min_version__.is_some() {
                                return Err(serde::de::Error::duplicate_field("minVersion"));
                            }
                            min_version__ = map_.next_value()?;
                        }
                        GeneratedField::MaxVersion => {
                            if max_version__.is_some() {
                                return Err(serde::de::Error::duplicate_field("maxVersion"));
                            }
                            max_version__ = map_.next_value()?;
                        }
                    }
                }
                Ok(DeleteVersionsReq {
                    agent: agent__,
                    uuid: uuid__,
                    min_version: min_version__,
                    max_version: max_version__,
                })
            }
        }
        deserializer.deserialize_struct("hi.ai.DeleteVersionsReq", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DevicePlugin {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.DevicePlugin", len)?;
        if let Some(v) = self.uuid.as_ref() {
            struct_ser.serialize_field("uuid", v)?;
        }
        if let Some(v) = self.name.as_ref() {
        ...
        if let Some(v) = self.fn_prefix.as_ref() {
            struct_ser.serialize_field("fnPrefix", v)?;
        }
        ...
        if let Some(v) = self.lang.as_ref() {
            let v = PluginLang::try_from(*v)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", *v)))?;
            struct_ser.serialize_field("lang", &v)?;
        }
        if !self.deps.is_empty() {
...
impl<'de> serde::Deserialize<'de> for DevicePlugin {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                impl serde::de::Visitor<'_> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "name" => Ok(GeneratedField::Name),
                            "version" => Ok(GeneratedField::Version),
                            "fnPrefix" | "fn_prefix" => Ok(GeneratedField::FnPrefix),
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = DevicePlugin;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.DevicePlugin")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<DevicePlugin, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut uuid__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::FnPrefix => {
                            if fn_prefix__.is_some() {
                                return Err(serde::de::Error::duplicate_field("fnPrefix"));
                            }
                            fn_prefix__ = map_.next_value()?;
                        }
                        GeneratedField::Url => {
                            if url__.is_some() {
                        ...
                        GeneratedField::Lang => {
                            ...
                            lang__ = map_.next_value::<::std::option::Option<PluginLang>>()?.map(|x| x as i32);
                        }
                        GeneratedField::Deps => {
                            if deps__.is_some() {
        ...
        deserializer.deserialize_struct("hi.ai.DevicePlugin", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DownloadFileReq {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.DownloadFileReq", len)?;
        if let Some(v) = self.agent.as_ref() {
            struct_ser.serialize_field("agent", v)?;
        }
        if let Some(v) = self.uuid.as_ref() {
...
impl<'de> serde::Deserialize<'de> for DownloadFileReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = DownloadFileReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.DownloadFileReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<DownloadFileReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut agent__ = None;
        ...
        deserializer.deserialize_struct("hi.ai.DownloadFileReq", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DownloadFileResp {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.DownloadFileResp", len)?;
        if let Some(v) = self.content.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for DownloadFileResp {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = DownloadFileResp;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.DownloadFileResp")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<DownloadFileResp, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut content__ = None;
        ...
        deserializer.deserialize_struct("hi.ai.DownloadFileResp", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DownloadScriptReq {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
...
impl<'de> serde::Deserialize<'de> for DownloadScriptReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = DownloadScriptReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.DownloadScriptReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<DownloadScriptReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut agent__ = None;
        ...
        deserializer.deserialize_struct("hi.ai.DownloadScriptReq", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DownloadScriptResp {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.DownloadScriptResp", len)?;
        if let Some(v) = self.content.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("content", pbjson::private::base64::encode(&v).as_str())?;
...
impl<'de> serde::Deserialize<'de> for DownloadScriptResp {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = DownloadScriptResp;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.DownloadScriptResp")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<DownloadScriptResp, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut content__ = None;
                ...
                Ok(DownloadScriptResp {
                    content: content__,
                    name: name__,
                })
            }
        }
        deserializer.deserialize_struct("hi.ai.DownloadScriptResp", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for HaveDep {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.HaveDep", len)?;
...
impl<'de> serde::Deserialize<'de> for HaveDep {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.HaveDep")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<HaveDep, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut rock__ = None;
        ...
        deserializer.deserialize_struct("hi.ai.HaveDep", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ListAgentDelayHistoryReq {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.ListAgentDelayHistoryReq", len)?;
        if let Some(v) = self.agent.as_ref() {
            struct_ser.serialize_field("agent", v)?;
        }
        if let Some(v) = self.r#type.as_ref() {
...
impl<'de> serde::Deserialize<'de> for ListAgentDelayHistoryReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ListAgentDelayHistoryReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.ListAgentDelayHistoryReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ListAgentDelayHistoryReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut agent__ = None;
        ...
        deserializer.deserialize_struct("hi.ai.ListAgentDelayHistoryReq", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for ListAgentPermissionsReq {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.ListAgentPermissionsReq", len)?;
        if !self.agents.is_empty() {
            struct_ser.serialize_field("agents", &self.agents)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for ListAgentPermissionsReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ListAgentPermissionsReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.ListAgentPermissionsReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ListAgentPermissionsReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut agents__ = None;
                ...
                Ok(ListAgentPermissionsReq {
                    agents: agents__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("hi.ai.ListAgentPermissionsReq", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ListAgentPermissionsResp {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.ListAgentPermissionsResp", len)?;
        if !self.infos.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ListAgentPermissionsResp {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ListAgentPermissionsResp;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.ListAgentPermissionsResp")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ListAgentPermissionsResp, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(ListAgentPermissionsResp {
                    infos: infos__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("hi.ai.ListAgentPermissionsResp", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for ListFilesReq {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.r#use.as_ref() {
            struct_ser.serialize_field("use", v)?;
        }
        if let Some(v) = self.pagination.as_ref() {
            struct_ser.serialize_field("pagination", v)?;
        }
...
impl serde::Serialize for ListOnDeviceReq {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.ListOnDeviceReq", len)?;
        if let Some(v) = self.agent.as_ref() {
            struct_ser.serialize_field("agent", v)?;
        }
...
impl<'de> serde::Deserialize<'de> for ListOnDeviceReq {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.ListOnDeviceReq")
            }
        ...
        deserializer.deserialize_struct("hi.ai.ListOnDeviceReq", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ListOnDeviceResp {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.ListOnDeviceResp", len)?;
        if !self.list.is_empty() {
            struct_ser.serialize_field("list", &self.list)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for ListOnDeviceResp {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ListOnDeviceResp;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.ListOnDeviceResp")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ListOnDeviceResp, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut list__ = None;
        ...
        deserializer.deserialize_struct("hi.ai.ListOnDeviceResp", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for ListVersionsResp {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.ListVersionsResp", len)?;
        if let Some(v) = self.total.as_ref() {
            struct_ser.serialize_field("total", v)?;
        }
        if !self.list.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ListVersionsResp {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ListVersionsResp;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.ListVersionsResp")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ListVersionsResp, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut total__ = None;
...
impl serde::Serialize for LuaDep {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.LuaDep", len)?;
        if let Some(v) = self.rock.as_ref() {
            struct_ser.serialize_field("rock", v)?;
        }
        if let Some(v) = self.version.as_ref() {
...
impl<'de> serde::Deserialize<'de> for LuaDep {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.LuaDep")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<LuaDep, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut rock__ = None;
        ...
        deserializer.deserialize_struct("hi.ai.LuaDep", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for LuaDepFile {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.LuaDepFile", len)?;
        if let Some(v) = self.path.as_ref() {
            struct_ser.serialize_field("path", v)?;
        }
        if let Some(v) = self.url.as_ref() {
...
impl<'de> serde::Deserialize<'de> for LuaDepFile {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = LuaDepFile;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.LuaDepFile")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<LuaDepFile, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut path__ = None;
        ...
        deserializer.deserialize_struct("hi.ai.LuaDepFile", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for ModelSet {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.mem_model.as_ref() {
            struct_ser.serialize_field("memModel", v)?;
        }
        struct_ser.end()
    }
}
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Llm => {
                            ...
                            llm__ = map_.next_value()?;
                        }
                        GeneratedField::Stt => {
                            if stt__.is_some() {
                                return Err(serde::de::Error::duplicate_field("stt"));
                            }
                            stt__ = map_.next_value()?;
                        }
                        GeneratedField::Tts => {
                            if tts__.is_some() {
                                return Err(serde::de::Error::duplicate_field("tts"));
                            }
                            tts__ = map_.next_value()?;
                        }
...
impl serde::Serialize for PermissionAddReq {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.r#type.as_ref() {
            let v = PermissionType::try_from(*v)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", *v)))?;
            struct_ser.serialize_field("type", &v)?;
        }
        struct_ser.end()
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::Type => {
                            ...
                            r#type__ = map_.next_value::<::std::option::Option<PermissionType>>()?.map(|x| x as i32);
                        }
                    }
                }
                Ok(PermissionAddReq {
...
impl serde::Serialize for PluginArtifact {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.PluginArtifact", len)?;
        if let Some(v) = self.uuid.as_ref() {
            struct_ser.serialize_field("uuid", v)?;
        }
        if let Some(v) = self.version.as_ref() {
        ...
        if let Some(v) = self.status.as_ref() {
            let v = PluginArtifactStatus::try_from(*v)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", *v)))?;
        ...
        if let Some(v) = self.finished_at.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("finishedAt", ToString::to_string(&v).as_str())?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for PluginArtifact {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = PluginArtifact;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.PluginArtifact")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<PluginArtifact, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut uuid__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::Status => {
                            ...
                            status__ = map_.next_value::<::std::option::Option<PluginArtifactStatus>>()?.map(|x| x as i32);
                        }
        ...
        deserializer.deserialize_struct("hi.ai.PluginArtifact", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PluginArtifactStatus {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
...
impl<'de> serde::Deserialize<'de> for PluginArtifactStatus {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl serde::de::Visitor<'_> for GeneratedVisitor {
            type Value = PluginArtifactStatus;
            ...
            {
                match value {
                    "PLUGIN_ARTIFACT_STATUS_PENDING" => Ok(PluginArtifactStatus::Pending),
                    "PLUGIN_ARTIFACT_STATUS_BUILDING" => Ok(PluginArtifactStatus::Building),
                    "PLUGIN_ARTIFACT_STATUS_SUCCEEDED" => Ok(PluginArtifactStatus::Succeeded),
                    "PLUGIN_ARTIFACT_STATUS_FAILED" => Ok(PluginArtifactStatus::Failed),
                    _ => Err(serde::de::Error::unknown_variant(value, FIELDS)),
                }
            }
        }
...
impl serde::Serialize for PluginLang {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
...
impl<'de> serde::Deserialize<'de> for PluginLang {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl serde::de::Visitor<'_> for GeneratedVisitor {
            ...
            {
                match value {
                    "PLUGIN_LANG_PYTHON" => Ok(PluginLang::Python),
                    "PLUGIN_LANG_RUST" => Ok(PluginLang::Rust),
                    "PLUGIN_LANG_UNDETERMINED" => Ok(PluginLang::Undetermined),
                    "PLUGIN_LANG_LUA" => Ok(PluginLang::Lua),
                    _ => Err(serde::de::Error::unknown_variant(value, FIELDS)),
                }
            }
        }
...
impl serde::Serialize for PluginLoaded {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.PluginLoaded", len)?;
        if let Some(v) = self.uuid.as_ref() {
            struct_ser.serialize_field("uuid", v)?;
        }
        if let Some(v) = self.name.as_ref() {
...
impl<'de> serde::Deserialize<'de> for PluginLoaded {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = PluginLoaded;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.PluginLoaded")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<PluginLoaded, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut uuid__ = None;
...
impl serde::Serialize for PluginPublicBrief {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.PluginPublicBrief", len)?;
        if let Some(v) = self.agent.as_ref() {
            struct_ser.serialize_field("agent", v)?;
        }
        if let Some(v) = self.uuid.as_ref() {
...
impl<'de> serde::Deserialize<'de> for PluginPublicBrief {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = PluginPublicBrief;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.PluginPublicBrief")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<PluginPublicBrief, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut agent__ = None;
        ...
        deserializer.deserialize_struct("hi.ai.PluginPublicBrief", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PluginRef {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.PluginRef", len)?;
        if let Some(v) = self.agent.as_ref() {
            struct_ser.serialize_field("agent", v)?;
        }
        if let Some(v) = self.uuid.as_ref() {
...
impl<'de> serde::Deserialize<'de> for PluginRef {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.PluginRef")
            }
        ...
        deserializer.deserialize_struct("hi.ai.PluginRef", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for PluginShell {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = PluginShell;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.PluginShell")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<PluginShell, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut uuid__ = None;
        ...
        deserializer.deserialize_struct("hi.ai.PluginShell", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for PluginVersion {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = PluginVersion;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.PluginVersion")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<PluginVersion, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut uuid__ = None;
        ...
        deserializer.deserialize_struct("hi.ai.PluginVersion", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PluginVersionView {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
...
impl<'de> serde::Deserialize<'de> for PluginVersionView {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = PluginVersionView;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.PluginVersionView")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<PluginVersionView, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut version__ = None;
        ...
        deserializer.deserialize_struct("hi.ai.PluginVersionView", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PluginView {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.source.as_ref() {
            let v = PluginSource::try_from(*v)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", *v)))?;
            struct_ser.serialize_field("source", &v)?;
        }
        if let Some(v) = self.ref_count.as_ref() {
            struct_ser.serialize_field("refCount", v)?;
        }
        if let Some(v) = self.data.as_ref() {
            struct_ser.serialize_field("data", v)?;
        }
...
impl<'de> serde::Deserialize<'de> for PluginView {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = PluginView;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.PluginView")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<PluginView, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::Source => {
                            ...
                            source__ = map_.next_value::<::std::option::Option<PluginSource>>()?.map(|x| x as i32);
                        }
        ...
        deserializer.deserialize_struct("hi.ai.PluginView", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for PublicBriefsReq {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.PublicBriefsReq", len)?;
        if !self.refs.is_empty() {
...
impl<'de> serde::Deserialize<'de> for PublicBriefsReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = PublicBriefsReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.PublicBriefsReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<PublicBriefsReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut refs__ = None;
        ...
        deserializer.deserialize_struct("hi.ai.PublicBriefsReq", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PublicBriefsResp {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.PublicBriefsResp", len)?;
        if !self.briefs.is_empty() {
            struct_ser.serialize_field("briefs", &self.briefs)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for PublicBriefsResp {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl serde::de::Visitor<'_> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "briefs" => Ok(GeneratedField::Briefs),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = PublicBriefsResp;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.PublicBriefsResp")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<PublicBriefsResp, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut briefs__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Briefs => {
                            if briefs__.is_some() {
                                return Err(serde::de::Error::duplicate_field("briefs"));
                            }
                            briefs__ = Some(map_.next_value()?);
                        }
                    }
                }
                Ok(PublicBriefsResp {
                    briefs: briefs__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("hi.ai.PublicBriefsResp", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for RegisterRobotReq {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.RegisterRobotReq", len)?;
        if !self.did.is_empty() {
            struct_ser.serialize_field("did", &self.did)?;
        }
        if let Some(v) = self.name.as_ref() {
...
impl<'de> serde::Deserialize<'de> for RegisterRobotReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = RegisterRobotReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.RegisterRobotReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<RegisterRobotReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut did__ = None;
        ...
        deserializer.deserialize_struct("hi.ai.RegisterRobotReq", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for RetryBuildReq {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.RetryBuildReq", len)?;
        if let Some(v) = self.agent.as_ref() {
            struct_ser.serialize_field("agent", v)?;
        }
        if let Some(v) = self.uuid.as_ref() {
...
impl<'de> serde::Deserialize<'de> for RetryBuildReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = RetryBuildReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.RetryBuildReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<RetryBuildReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut agent__ = None;
        ...
        deserializer.deserialize_struct("hi.ai.RetryBuildReq", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SetActiveAllReq {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.SetActiveAllReq", len)?;
        if let Some(v) = self.uuid.as_ref() {
            struct_ser.serialize_field("uuid", v)?;
        }
        if let Some(v) = self.version.as_ref() {
...
impl<'de> serde::Deserialize<'de> for SetActiveAllReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = SetActiveAllReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.SetActiveAllReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<SetActiveAllReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut uuid__ = None;
        ...
        deserializer.deserialize_struct("hi.ai.SetActiveAllReq", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SetActiveAllResp {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.SetActiveAllResp", len)?;
        if let Some(v) = self.switched.as_ref() {
            struct_ser.serialize_field("switched", v)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for SetActiveAllResp {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl serde::de::Visitor<'_> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "switched" => Ok(GeneratedField::Switched),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = SetActiveAllResp;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.SetActiveAllResp")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<SetActiveAllResp, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut switched__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Switched => {
                            if switched__.is_some() {
                                return Err(serde::de::Error::duplicate_field("switched"));
                            }
                            switched__ = 
                                map_.next_value::<::std::option::Option<::pbjson::private::NumberDeserialize<_>>>()?.map(|x| x.0)
                            ;
        ...
        deserializer.deserialize_struct("hi.ai.SetActiveAllResp", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SetActiveReq {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
...
impl<'de> serde::Deserialize<'de> for SetActiveReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = SetActiveReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.SetActiveReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<SetActiveReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut agent__ = None;
        ...
        deserializer.deserialize_struct("hi.ai.SetActiveReq", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for SettingInfo {
        ...
        S: serde::Serializer,
    {
        ...
        if self.proxy_enable.is_some() {
            len += 1;
        }
        if self.openai_endpoint.is_some() {
            len += 1;
        }
        if self.openai_endpoint_enable.is_some() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("hi.ai.SettingInfo", len)?;
        if let Some(v) = self.proxy_endpoint.as_ref() {
            struct_ser.serialize_field("proxyEndpoint", v)?;
        }
        if let Some(v) = self.proxy_enable.as_ref() {
            struct_ser.serialize_field("proxyEnable", v)?;
        }
        if let Some(v) = self.openai_endpoint.as_ref() {
            struct_ser.serialize_field("openaiEndpoint", v)?;
        }
        if let Some(v) = self.openai_endpoint_enable.as_ref() {
            struct_ser.serialize_field("openaiEndpointEnable", v)?;
        }
        struct_ser.end()
    }
}
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::OpenaiEndpointEnable => {
                            ...
                            openai_endpoint_enable__ = map_.next_value()?;
                        }
                    }
                }
                Ok(SettingInfo {
                    proxy_endpoint: proxy_endpoint__,
                    proxy_enable: proxy_enable__,
                    openai_endpoint: openai_endpoint__,
                    openai_endpoint_enable: openai_endpoint_enable__,
                })
            }
        }
...
impl serde::Serialize for StatusResp {
        ...
        S: serde::Serializer,
    {
        ...
        if self.mem_count.is_some() {
            len += 1;
        }
        if self.slice_count.is_some() {
            len += 1;
        }
        if self.message.is_some() {
            len += 1;
        ...
        if let Some(v) = self.mem_count.as_ref() {
            struct_ser.serialize_field("memCount", v)?;
        }
        if let Some(v) = self.slice_count.as_ref() {
            struct_ser.serialize_field("sliceCount", v)?;
        }
        if let Some(v) = self.message.as_ref() {
            struct_ser.serialize_field("message", v)?;
        }
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(StatusResp {
                    status: status__,
                    mem_count: mem_count__,
                    slice_count: slice_count__,
                    message: message__,
                })
            }
        }
...
impl serde::Serialize for TokenUsage {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.mem.as_ref() {
            struct_ser.serialize_field("mem", v)?;
        }
        struct_ser.end()
    }
}
...
impl serde::Serialize for TrainingFile {
        ...
        S: serde::Serializer,
    {
        ...
        if self.is_use.is_some() {
            len += 1;
        }
        if self.digest.is_some() {
            len += 1;
        }
        if self.training_time.is_some() {
            len += 1;
        }
        if self.created_at.is_some() {
            len += 1;
        ...
        if let Some(v) = self.is_use.as_ref() {
            struct_ser.serialize_field("isUse", v)?;
        }
        if let Some(v) = self.digest.as_ref() {
            struct_ser.serialize_field("digest", v)?;
        }
        if let Some(v) = self.training_time.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("trainingTime", ToString::to_string(&v).as_str())?;
        }
        if let Some(v) = self.created_at.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
