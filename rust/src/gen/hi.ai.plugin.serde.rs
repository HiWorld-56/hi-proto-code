...
impl serde::Serialize for LuaDepRef {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.plugin.LuaDepRef", len)?;
        if let Some(v) = self.rock.as_ref() {
            struct_ser.serialize_field("rock", v)?;
        }
        if let Some(v) = self.version.as_ref() {
...
impl<'de> serde::Deserialize<'de> for LuaDepRef {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = LuaDepRef;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.plugin.LuaDepRef")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<LuaDepRef, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut rock__ = None;
        ...
        deserializer.deserialize_struct("hi.ai.plugin.LuaDepRef", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for LuaDepRequiresReq {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.plugin.LuaDepRequiresReq", len)?;
        if let Some(v) = self.rock.as_ref() {
            struct_ser.serialize_field("rock", v)?;
        }
        if let Some(v) = self.version.as_ref() {
...
impl<'de> serde::Deserialize<'de> for LuaDepRequiresReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = LuaDepRequiresReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.plugin.LuaDepRequiresReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<LuaDepRequiresReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut rock__ = None;
                ...
                Ok(LuaDepRequiresReq {
                    rock: rock__,
                    version: version__,
                })
            }
        }
        deserializer.deserialize_struct("hi.ai.plugin.LuaDepRequiresReq", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for LuaDepRequiresResp {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.ai.plugin.LuaDepRequiresResp", len)?;
        if let Some(v) = self.ok.as_ref() {
            struct_ser.serialize_field("ok", v)?;
        }
        if !self.requires.is_empty() {
...
impl<'de> serde::Deserialize<'de> for LuaDepRequiresResp {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = LuaDepRequiresResp;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.ai.plugin.LuaDepRequiresResp")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<LuaDepRequiresResp, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut ok__ = None;
        ...
        deserializer.deserialize_struct("hi.ai.plugin.LuaDepRequiresResp", FIELDS, GeneratedVisitor)
    }
}
