...
impl serde::Serialize for AddFriendResp {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.status.as_ref() {
            let v = FriendRequestStatus::try_from(*v)
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Status => {
                            ...
                            status__ = map_.next_value::<::std::option::Option<FriendRequestStatus>>()?.map(|x| x as i32);
                        }
                    }
                }
                Ok(AddFriendResp {
...
impl serde::Serialize for ApplyReq {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.listing_uuid.as_ref() {
            struct_ser.serialize_field("listingUuid", v)?;
        }
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::ListingUuid => {
                            ...
                            listing_uuid__ = map_.next_value()?;
                        }
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::GrantUuid => {
                            ...
                            grant_uuid__ = map_.next_value()?;
                        }
                        GeneratedField::Status => {
                            if status__.is_some() {
                                return Err(serde::de::Error::duplicate_field("status"));
                            }
                            status__ = map_.next_value::<::std::option::Option<GrantStatus>>()?.map(|x| x as i32);
                        }
...
;
                        ...
                        GeneratedField::StocksPlaceEquityOrder => {
                            ...
                            op__ = map_.next_value::<::std::option::Option<_>>()?.map(binance_send_req::Op::StocksPlaceEquityOrder)
;
                        }
                        GeneratedField::StocksCancelEquityOrder => {
                            ...
                            op__ = map_.next_value::<::std::option::Option<_>>()?.map(binance_send_req::Op::StocksCancelEquityOrder)
;
                        }
                        GeneratedField::StocksCancelAllEquityOrders => {
                            ...
                            op__ = map_.next_value::<::std::option::Option<_>>()?.map(binance_send_req::Op::StocksCancelAllEquityOrders)
;
                        }
                        GeneratedField::StocksCurrentOpenOrders => {
                            ...
                            op__ = map_.next_value::<::std::option::Option<_>>()?.map(binance_send_req::Op::StocksCurrentOpenOrders)
;
                        }
                        GeneratedField::StocksEquityOrderDetail => {
                            ...
                            op__ = map_.next_value::<::std::option::Option<_>>()?.map(binance_send_req::Op::StocksEquityOrderDetail)
;
                        }
                        GeneratedField::StocksEquityOrderHistory => {
                            ...
                            op__ = map_.next_value::<::std::option::Option<_>>()?.map(binance_send_req::Op::StocksEquityOrderHistory)
;
                        }
                        GeneratedField::StocksEquityTradeHistory => {
                            ...
                            op__ = map_.next_value::<::std::option::Option<_>>()?.map(binance_send_req::Op::StocksEquityTradeHistory)
;
                        }
                        GeneratedField::StocksExchangeInfo => {
                            ...
                            op__ = map_.next_value::<::std::option::Option<_>>()?.map(binance_send_req::Op::StocksExchangeInfo)
;
                        }
...
;
                        ...
                        GeneratedField::WalletQueryUserWalletBalance => {
                            ...
                            op__ = map_.next_value::<::std::option::Option<_>>()?.map(binance_send_req::Op::WalletQueryUserWalletBalance)
;
                        }
                    }
                }
...
impl serde::Serialize for CreateListingReq {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.settle_mode.as_ref() {
            let v = SettleMode::try_from(*v)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", *v)))?;
        ...
        if let Some(v) = self.kind.as_ref() {
            let v = MarketListingKind::try_from(*v)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", *v)))?;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::SettleMode => {
                            ...
                            settle_mode__ = map_.next_value::<::std::option::Option<SettleMode>>()?.map(|x| x as i32);
                        }
                        ...
                        GeneratedField::Kind => {
                            ...
                            kind__ = map_.next_value::<::std::option::Option<MarketListingKind>>()?.map(|x| x as i32);
                        }
                    }
                }
                Ok(CreateListingReq {
...
impl serde::Serialize for FundsRecord {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.kind.as_ref() {
            let v = FundsKind::try_from(*v)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", *v)))?;
            struct_ser.serialize_field("kind", &v)?;
        }
        if let Some(v) = self.payer.as_ref() {
            struct_ser.serialize_field("payer", v)?;
        }
        ...
        if let Some(v) = self.fee_coin.as_ref() {
            struct_ser.serialize_field("feeCoin", v)?;
        }
        if let Some(v) = self.tx_hash.as_ref() {
            struct_ser.serialize_field("txHash", v)?;
        }
        if let Some(v) = self.status.as_ref() {
            let v = FundsStatus::try_from(*v)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", *v)))?;
            struct_ser.serialize_field("status", &v)?;
        }
        if let Some(v) = self.reason.as_ref() {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::Kind => {
                            ...
                            kind__ = map_.next_value::<::std::option::Option<FundsKind>>()?.map(|x| x as i32);
                        }
                        GeneratedField::Payer => {
                            if payer__.is_some() {
                                return Err(serde::de::Error::duplicate_field("payer"));
                            }
                            payer__ = map_.next_value()?;
                        }
                        ...
                        GeneratedField::Status => {
                            ...
                            status__ = map_.next_value::<::std::option::Option<FundsStatus>>()?.map(|x| x as i32);
                        }
                        GeneratedField::Reason => {
                            if reason__.is_some() {
                                return Err(serde::de::Error::duplicate_field("reason"));
...
impl serde::Serialize for GetAgentMomentReq {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.club.GetAgentMomentReq", len)?;
        if let Some(v) = self.agent.as_ref() {
            struct_ser.serialize_field("agent", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for GetAgentMomentReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetAgentMomentReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.club.GetAgentMomentReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetAgentMomentReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut agent__ = None;
                ...
                Ok(GetAgentMomentReq {
                    agent: agent__,
                })
            }
        }
        deserializer.deserialize_struct("hi.club.GetAgentMomentReq", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetAgentMomentResp {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.club.GetAgentMomentResp", len)?;
...
impl<'de> serde::Deserialize<'de> for GetAgentMomentResp {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetAgentMomentResp;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.club.GetAgentMomentResp")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetAgentMomentResp, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
...
impl serde::Serialize for GetSellerReq {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.club.GetSellerReq", len)?;
        if let Some(v) = self.master.as_ref() {
            struct_ser.serialize_field("master", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for GetSellerReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetSellerReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.club.GetSellerReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetSellerReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut master__ = None;
        ...
        deserializer.deserialize_struct("hi.club.GetSellerReq", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for GetTransactionReq {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let mut len = 0;
        if self.pay_id.is_some() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("hi.club.GetTransactionReq", len)?;
        if let Some(v) = self.pay_id.as_ref() {
            struct_ser.serialize_field("payId", v)?;
        }
        struct_ser.end()
    }
}
...
impl serde::Serialize for GroupMemberAttr {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.muted.as_ref() {
            struct_ser.serialize_field("muted", v)?;
        }
        struct_ser.end()
    }
}
...
impl serde::Serialize for GroupMemberView {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.dnd.as_ref() {
            struct_ser.serialize_field("dnd", v)?;
        }
        struct_ser.end()
    }
}
...
impl serde::Serialize for JoinMerchantReq {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.club.JoinMerchantReq", len)?;
...
impl<'de> serde::Deserialize<'de> for JoinMerchantReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = JoinMerchantReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.club.JoinMerchantReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<JoinMerchantReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("hi.club.JoinMerchantReq", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for ListGrantsReq {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.initiator.as_ref() {
            let v = GrantInitiator::try_from(*v)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", *v)))?;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::Initiator => {
                            ...
                            initiator__ = map_.next_value::<::std::option::Option<GrantInitiator>>()?.map(|x| x as i32);
                        }
                    }
                }
                Ok(ListGrantsReq {
...
impl serde::Serialize for ListMerchantUsersReq {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.club.ListMerchantUsersReq", len)?;
        if let Some(v) = self.merchant.as_ref() {
            struct_ser.serialize_field("merchant", v)?;
        }
        if let Some(v) = self.pagination.as_ref() {
...
impl<'de> serde::Deserialize<'de> for ListMerchantUsersReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ListMerchantUsersReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.club.ListMerchantUsersReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ListMerchantUsersReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut merchant__ = None;
                ...
                Ok(ListMerchantUsersReq {
                    merchant: merchant__,
                    pagination: pagination__,
                })
            }
        }
        deserializer.deserialize_struct("hi.club.ListMerchantUsersReq", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for ListOnlineReq {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.owner_did.as_ref() {
            struct_ser.serialize_field("ownerDid", v)?;
        }
        if let Some(v) = self.pagination.as_ref() {
            struct_ser.serialize_field("pagination", v)?;
        }
...
impl serde::Serialize for ListPendingNoticesResp {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.club.ListPendingNoticesResp", len)?;
        if !self.list.is_empty() {
            struct_ser.serialize_field("list", &self.list)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for ListPendingNoticesResp {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ListPendingNoticesResp;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.club.ListPendingNoticesResp")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ListPendingNoticesResp, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut list__ = None;
...
impl serde::Serialize for ListSellerStallsReq {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.club.ListSellerStallsReq", len)?;
        if let Some(v) = self.master.as_ref() {
            struct_ser.serialize_field("master", v)?;
        }
        if let Some(v) = self.pagination.as_ref() {
...
impl<'de> serde::Deserialize<'de> for ListSellerStallsReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ListSellerStallsReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.club.ListSellerStallsReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ListSellerStallsReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut master__ = None;
                ...
                Ok(ListSellerStallsReq {
                    master: master__,
                    pagination: pagination__,
                })
            }
        }
        deserializer.deserialize_struct("hi.club.ListSellerStallsReq", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ListSellerStallsResp {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.club.ListSellerStallsResp", len)?;
        if let Some(v) = self.total.as_ref() {
            struct_ser.serialize_field("total", v)?;
        }
        if !self.stalls.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ListSellerStallsResp {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ListSellerStallsResp;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.club.ListSellerStallsResp")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ListSellerStallsResp, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut total__ = None;
                ...
                Ok(ListSellerStallsResp {
                    total: total__,
                    stalls: stalls__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("hi.club.ListSellerStallsResp", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ListSellerUsersReq {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.club.ListSellerUsersReq", len)?;
        if let Some(v) = self.master.as_ref() {
            struct_ser.serialize_field("master", v)?;
        }
        if let Some(v) = self.pagination.as_ref() {
...
impl<'de> serde::Deserialize<'de> for ListSellerUsersReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ListSellerUsersReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.club.ListSellerUsersReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ListSellerUsersReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut master__ = None;
                ...
                Ok(ListSellerUsersReq {
                    master: master__,
                    pagination: pagination__,
                })
            }
        }
        deserializer.deserialize_struct("hi.club.ListSellerUsersReq", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ListSellerUsersResp {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.club.ListSellerUsersResp", len)?;
        if let Some(v) = self.total.as_ref() {
            struct_ser.serialize_field("total", v)?;
        }
        if !self.users.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ListSellerUsersResp {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ListSellerUsersResp;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.club.ListSellerUsersResp")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ListSellerUsersResp, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut total__ = None;
                ...
                Ok(ListSellerUsersResp {
                    total: total__,
                    users: users__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("hi.club.ListSellerUsersResp", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for MarketGrantView {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.decided_at.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("decidedAt", ToString::to_string(&v).as_str())?;
        }
        if let Some(v) = self.installed_at.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("installedAt", ToString::to_string(&v).as_str())?;
        }
        if let Some(v) = self.auto_renew.as_ref() {
            struct_ser.serialize_field("autoRenew", v)?;
        }
        if let Some(v) = self.initiator.as_ref() {
            let v = GrantInitiator::try_from(*v)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", *v)))?;
...
impl serde::Serialize for MarketListingBrief {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.install_count.as_ref() {
            struct_ser.serialize_field("installCount", v)?;
        }
        if let Some(v) = self.kind.as_ref() {
            let v = MarketListingKind::try_from(*v)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", *v)))?;
...
impl serde::Serialize for MarketListingDetail {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.status.as_ref() {
            let v = ListingStatus::try_from(*v)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", *v)))?;
            struct_ser.serialize_field("status", &v)?;
        }
        if let Some(v) = self.plugin_uuid.as_ref() {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::Status => {
                            ...
                            status__ = map_.next_value::<::std::option::Option<ListingStatus>>()?.map(|x| x as i32);
                        }
                        GeneratedField::PluginUuid => {
                            if plugin_uuid__.is_some() {
                                return Err(serde::de::Error::duplicate_field("pluginUuid"));
...
impl serde::Serialize for MarketNotifyData {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.outer_id.as_ref() {
            struct_ser.serialize_field("outerId", v)?;
        }
...
impl serde::Serialize for MarketOrder {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.target_agent.as_ref() {
            struct_ser.serialize_field("targetAgent", v)?;
        }
        if let Some(v) = self.kind.as_ref() {
            let v = MarketOrderKind::try_from(*v)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", *v)))?;
            struct_ser.serialize_field("kind", &v)?;
        }
        if let Some(v) = self.status.as_ref() {
            let v = MarketOrderStatus::try_from(*v)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", *v)))?;
            struct_ser.serialize_field("status", &v)?;
        }
        if let Some(v) = self.payee.as_ref() {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::TargetAgent => {
                            ...
                            target_agent__ = map_.next_value()?;
                        }
                        GeneratedField::Kind => {
                            if kind__.is_some() {
                                return Err(serde::de::Error::duplicate_field("kind"));
                            }
                            kind__ = map_.next_value::<::std::option::Option<MarketOrderKind>>()?.map(|x| x as i32);
                        }
                        GeneratedField::Status => {
                            if status__.is_some() {
                                return Err(serde::de::Error::duplicate_field("status"));
                            }
                            status__ = map_.next_value::<::std::option::Option<MarketOrderStatus>>()?.map(|x| x as i32);
                        }
                        GeneratedField::Payee => {
                            if payee__.is_some() {
                                return Err(serde::de::Error::duplicate_field("payee"));
...
impl serde::Serialize for MarketPayment {
        ...
        S: serde::Serializer,
    {
        ...
        if self.to_account.is_some() {
            len += 1;
        }
        if self.pay_req_id.is_some() {
            len += 1;
        }
        ...
        if let Some(v) = self.status.as_ref() {
            let v = MarketPaymentStatus::try_from(*v)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", *v)))?;
            struct_ser.serialize_field("status", &v)?;
        }
        if let Some(v) = self.tx_hash.as_ref() {
        ...
        if let Some(v) = self.to_account.as_ref() {
            struct_ser.serialize_field("toAccount", v)?;
        }
        if let Some(v) = self.pay_req_id.as_ref() {
            struct_ser.serialize_field("payReqId", v)?;
        }
        struct_ser.end()
    }
}
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::Status => {
                            ...
                            status__ = map_.next_value::<::std::option::Option<MarketPaymentStatus>>()?.map(|x| x as i32);
                        }
                        GeneratedField::TxHash => {
                            if tx_hash__.is_some() {
                                return Err(serde::de::Error::duplicate_field("txHash"));
                ...
                Ok(MarketPayment {
                    ...
                    amount: amount__,
                    coin: coin__,
                    to_account: to_account__,
                    pay_req_id: pay_req_id__,
                })
            }
        }
...
impl serde::Serialize for MarketPendingGrant {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.to_master.as_ref() {
            struct_ser.serialize_field("toMaster", v)?;
        }
        if let Some(v) = self.settle_mode.as_ref() {
            let v = SettleMode::try_from(*v)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", *v)))?;
...
impl serde::Serialize for MarketSeller {
        ...
        S: serde::Serializer,
    {
        ...
        if self.stalls_count.is_some() {
            len += 1;
        }
        if self.listing_count.is_some() {
            len += 1;
        }
        if !self.support_coins.is_empty() {
            len += 1;
        }
        if self.is_merchant.is_some() {
            len += 1;
        }
        ...
        if let Some(v) = self.stalls_count.as_ref() {
            struct_ser.serialize_field("stallsCount", v)?;
        }
        if let Some(v) = self.listing_count.as_ref() {
            struct_ser.serialize_field("listingCount", v)?;
        }
        if !self.support_coins.is_empty() {
            struct_ser.serialize_field("supportCoins", &self.support_coins)?;
        }
        if let Some(v) = self.is_merchant.as_ref() {
            struct_ser.serialize_field("isMerchant", v)?;
        }
        struct_ser.end()
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                impl serde::de::Visitor<'_> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            "master" => Ok(GeneratedField::Master),
                            "moment" => Ok(GeneratedField::Moment),
                            "stallsCount" | "stalls_count" => Ok(GeneratedField::StallsCount),
                            "listingCount" | "listing_count" => Ok(GeneratedField::ListingCount),
                            "supportCoins" | "support_coins" => Ok(GeneratedField::SupportCoins),
                            "isMerchant" | "is_merchant" => Ok(GeneratedField::IsMerchant),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                let mut master__ = None;
                let mut moment__ = None;
                let mut stalls_count__ = None;
                let mut listing_count__ = None;
                let mut support_coins__ = None;
                let mut is_merchant__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Master => {
                            if master__.is_some() {
                        ...
                        GeneratedField::StallsCount => {
                            if stalls_count__.is_some() {
                                return Err(serde::de::Error::duplicate_field("stallsCount"));
                            }
                            stalls_count__ = 
                                map_.next_value::<::std::option::Option<::pbjson::private::NumberDeserialize<_>>>()?.map(|x| x.0)
                            ;
                        ...
                        GeneratedField::SupportCoins => {
                            if support_coins__.is_some() {
                                return Err(serde::de::Error::duplicate_field("supportCoins"));
                            }
                            support_coins__ = Some(map_.next_value()?);
                        }
                        GeneratedField::IsMerchant => {
                            if is_merchant__.is_some() {
                                return Err(serde::de::Error::duplicate_field("isMerchant"));
                            }
                            is_merchant__ = map_.next_value()?;
                        }
                    }
                }
                Ok(MarketSeller {
                    master: master__,
                    moment: moment__,
                    stalls_count: stalls_count__,
                    listing_count: listing_count__,
                    support_coins: support_coins__.unwrap_or_default(),
                    is_merchant: is_merchant__,
                })
            }
        }
...
impl serde::Serialize for MarketSellerUser {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.club.MarketSellerUser", len)?;
        if let Some(v) = self.user.as_ref() {
            struct_ser.serialize_field("user", v)?;
        }
        if let Some(v) = self.moment.as_ref() {
...
impl<'de> serde::Deserialize<'de> for MarketSellerUser {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = MarketSellerUser;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.club.MarketSellerUser")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MarketSellerUser, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut user__ = None;
        ...
        deserializer.deserialize_struct("hi.club.MarketSellerUser", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for OnlineAgentInfo {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.club.OnlineAgentInfo", len)?;
        if let Some(v) = self.agent.as_ref() {
            struct_ser.serialize_field("agent", v)?;
        }
        if let Some(v) = self.moment.as_ref() {
...
impl<'de> serde::Deserialize<'de> for OnlineAgentInfo {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = OnlineAgentInfo;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.club.OnlineAgentInfo")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<OnlineAgentInfo, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut agent__ = None;
        ...
        deserializer.deserialize_struct("hi.club.OnlineAgentInfo", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for OpenGroup {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
...
impl<'de> serde::Deserialize<'de> for OpenGroup {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = OpenGroup;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.club.OpenGroup")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<OpenGroup, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut base__ = None;
        ...
        deserializer.deserialize_struct("hi.club.OpenGroup", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for SearchListingsReq {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.keyword.as_ref() {
...
impl serde::Serialize for SetAgentMomentReq {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.club.SetAgentMomentReq", len)?;
        if let Some(v) = self.agent.as_ref() {
            struct_ser.serialize_field("agent", v)?;
        }
        if let Some(v) = self.moment.as_ref() {
...
impl<'de> serde::Deserialize<'de> for SetAgentMomentReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = SetAgentMomentReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.club.SetAgentMomentReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<SetAgentMomentReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut agent__ = None;
                ...
                Ok(SetAgentMomentReq {
                    agent: agent__,
                    moment: moment__,
                })
            }
        }
        deserializer.deserialize_struct("hi.club.SetAgentMomentReq", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for UpdateUserReq {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.verify_policy.as_ref() {
            struct_ser.serialize_field("verifyPolicy", v)?;
        }
        if let Some(v) = self.moment.as_ref() {
            struct_ser.serialize_field("moment", v)?;
        }
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::VerifyPolicy => {
                            ...
                            verify_policy__ = map_.next_value()?;
                        }
                        GeneratedField::Moment => {
                            if moment__.is_some() {
                                return Err(serde::de::Error::duplicate_field("moment"));
