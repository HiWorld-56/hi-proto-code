...
impl serde::Serialize for ListMyAgentsReq {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hi.club.ListMyAgentsReq", len)?;
        if let Some(v) = self.pagination.as_ref() {
            struct_ser.serialize_field("pagination", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for ListMyAgentsReq {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ListMyAgentsReq;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hi.club.ListMyAgentsReq")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ListMyAgentsReq, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut pagination__ = None;
        ...
        deserializer.deserialize_struct("hi.club.ListMyAgentsReq", FIELDS, GeneratedVisitor)
    }
}
