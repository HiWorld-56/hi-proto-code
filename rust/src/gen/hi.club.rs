...
pub mod user_acl_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("hi.club.UserACL", "ListUserAcls"));
            self.inner.unary(req, path, codec).await
        }
        #[deprecated]
        pub async fn list(
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("hi.club.UserACL", "ListUserAclTypes"));
            self.inner.unary(req, path, codec).await
        }
        #[deprecated]
...
pub mod api_key_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("hi.club.ApiKey", "ListApiKeys"));
            self.inner.unary(req, path, codec).await
        }
        #[deprecated]
        pub async fn list(
...
pub mod plugin_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("hi.club.Plugin", "ListPlugins"));
            self.inner.unary(req, path, codec).await
        }
        #[deprecated]
        pub async fn list(
...
pub mod gateway_config_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("hi.club.GatewayConfig", "ListGatewayConfigs"));
            self.inner.unary(req, path, codec).await
        }
        #[deprecated]
        pub async fn list(
