...
const (
	Publisher_Publish_FullMethodName = "/hi.club.Publisher/Publish"
)
...
func (c *publisherClient) Publish(ctx context.Context, in *PublishReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedPublisherServer) Publish(context.Context, *PublishReq) (*emptypb.Empty, error) {
...
func _Publisher_Publish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PublisherServer).Publish(ctx, req.(*PublishReq))
	}
...
var Publisher_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "hi/club/messaging.proto",
}
