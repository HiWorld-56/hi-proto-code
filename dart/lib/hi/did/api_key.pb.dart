...
class ListApiKeyReq extends $pb.GeneratedMessage {
  factory ListApiKeyReq({
    $core.String? user,
  ...
  factory ListApiKeyReq.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ListApiKeyReq.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ListApiKeyReq',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'hi.did'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'user')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListApiKeyReq clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListApiKeyReq copyWith(void Function(ListApiKeyReq) updates) =>
      super.copyWith((message) => updates(message as ListApiKeyReq))
          as ListApiKeyReq;
  ...
  @$core.pragma('dart2js:noInline')
  static ListApiKeyReq create() => ListApiKeyReq._();
  @$core.override
  ListApiKeyReq createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static ListApiKeyReq getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ListApiKeyReq>(create);
  static ListApiKeyReq? _defaultInstance;
...
class GetApiKeyReq extends $pb.GeneratedMessage {
  factory GetApiKeyReq({
    $core.String? apiKey,
  }) {
    final result = create();
    if (apiKey != null) result.apiKey = apiKey;
  ...
  factory GetApiKeyReq.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetApiKeyReq.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetApiKeyReq',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'hi.did'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'apiKey')
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetApiKeyReq clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetApiKeyReq copyWith(void Function(GetApiKeyReq) updates) =>
      super.copyWith((message) => updates(message as GetApiKeyReq))
          as GetApiKeyReq;
  ...
  @$core.pragma('dart2js:noInline')
  static GetApiKeyReq create() => GetApiKeyReq._();
  @$core.override
  GetApiKeyReq createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static GetApiKeyReq getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetApiKeyReq>(create);
  static GetApiKeyReq? _defaultInstance;
...
class GetApiKeyResp extends $pb.GeneratedMessage {
  factory GetApiKeyResp({
    ApiKeyInfo? info,
  }) {
    final result = create();
    if (info != null) result.info = info;
  ...
  factory GetApiKeyResp.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetApiKeyResp.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetApiKeyResp',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'hi.did'),
      createEmptyInstance: create)
    ..aOM<ApiKeyInfo>(1, _omitFieldNames ? '' : 'info',
        subBuilder: ApiKeyInfo.create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetApiKeyResp clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetApiKeyResp copyWith(void Function(GetApiKeyResp) updates) =>
      super.copyWith((message) => updates(message as GetApiKeyResp))
          as GetApiKeyResp;
  ...
  @$core.pragma('dart2js:noInline')
  static GetApiKeyResp create() => GetApiKeyResp._();
  @$core.override
  GetApiKeyResp createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static GetApiKeyResp getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetApiKeyResp>(create);
  static GetApiKeyResp? _defaultInstance;
