...
class GetUserByAddressReq extends $pb.GeneratedMessage {
  factory GetUserByAddressReq({
    $core.String? address,
  }) {
    final result = create();
    if (address != null) result.address = address;
  ...
  GetUserByAddressReq._();

  factory GetUserByAddressReq.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetUserByAddressReq.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetUserByAddressReq',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'hi.did'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetUserByAddressReq clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetUserByAddressReq copyWith(void Function(GetUserByAddressReq) updates) =>
      super.copyWith((message) => updates(message as GetUserByAddressReq))
          as GetUserByAddressReq;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetUserByAddressReq create() => GetUserByAddressReq._();
  @$core.override
  GetUserByAddressReq createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static GetUserByAddressReq getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetUserByAddressReq>(create);
  static GetUserByAddressReq? _defaultInstance;
...
class GetUserByAddressResp extends $pb.GeneratedMessage {
  factory GetUserByAddressResp({
    $core.String? did,
  }) {
    final result = create();
    if (did != null) result.did = did;
  ...
  GetUserByAddressResp._();

  factory GetUserByAddressResp.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetUserByAddressResp.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetUserByAddressResp',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'hi.did'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'did')
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetUserByAddressResp clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetUserByAddressResp copyWith(void Function(GetUserByAddressResp) updates) =>
      super.copyWith((message) => updates(message as GetUserByAddressResp))
          as GetUserByAddressResp;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetUserByAddressResp create() => GetUserByAddressResp._();
  @$core.override
  GetUserByAddressResp createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static GetUserByAddressResp getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetUserByAddressResp>(create);
  static GetUserByAddressResp? _defaultInstance;
