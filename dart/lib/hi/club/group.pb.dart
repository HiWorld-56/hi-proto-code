...
class UpdateGroupReq extends $pb.GeneratedMessage {
  factory UpdateGroupReq({
    GroupBase? base,
    $core.bool? clearBackground,
  }) {
    final result = create();
    if (base != null) result.base = base;
    if (clearBackground != null) result.clearBackground = clearBackground;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<GroupBase>(1, _omitFieldNames ? '' : 'base',
        subBuilder: GroupBase.create)
    ..aOB(2, _omitFieldNames ? '' : 'clearBackground')
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $core.bool get clearBackground => $_getBF(1);
  @$pb.TagNumber(2)
  set clearBackground($core.bool value) => $_setBool(1, value);
  @$pb.TagNumber(2)
  $core.bool hasClearBackground() => $_has(1);
  @$pb.TagNumber(2)
  void clearClearBackground() => $_clearField(2);
}
