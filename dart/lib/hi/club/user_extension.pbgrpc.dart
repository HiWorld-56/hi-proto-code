...
class UserExtensionClient extends $grpc.Client {
  ...
  static final _$get = $grpc.ClientMethod<$0.GetUserReq, $0.UserExtensionUnit>(
...
abstract class UserExtensionServiceBase extends $grpc.Service {
  ...
  UserExtensionServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.GetUserReq, $0.UserExtensionUnit>(
        'Get',
        get_Pre,
        false,
        false,
