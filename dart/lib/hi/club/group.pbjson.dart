...
/// Descriptor for `ListGroupsByCreatorReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listGroupsByCreatorReqDescriptor =
    $convert.base64Decode(
